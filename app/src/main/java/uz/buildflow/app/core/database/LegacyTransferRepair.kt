...
/**
 * Bir martalik tuzatish (6 -> 7): eski "Ko'chirish" funksiyasi faqat workers.object_id ni
 ...
 * Faqat ishchining joriy obyektiga (yoki NULL) yozilgan kunlar ko'chiriladi - yangi
 * TransferWorkerUseCase bilan to'g'ri ko'chirilgan kunlarga tegilmaydi.
 */
